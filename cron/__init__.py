"""
Cron job scheduling system for COCSO Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    cocso gateway install    # Install as a user service
    sudo cocso gateway install --system  # Linux servers: boot-time system service
    cocso gateway            # Or run in foreground
