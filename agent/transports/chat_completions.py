...
def is_moonshot_model(_model: str) -> bool:
    return False


def sanitize_moonshot_tools(tools):
    return tools
...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate COCSO/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from COCSO'
    ...
    # is stricter (low/high). Clamp COCSO' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        if is_nous:
            extra_body["tags"] = ["product=cocso-agent"]
