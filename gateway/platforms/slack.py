...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_cocso_home() / "slack_tokens.json"
        ...
        try:
            ...
            # /model work directly without /cocso prefix). A single regex
            ...
            # manifest (see `cocso slack manifest`). In Socket Mode, Slack
            ...
            from cocso_cli.commands import slack_native_slashes
            import re as _re
            ...
            if _slash_names:
                ...
                _slash_pattern = _re.compile(r"^/cocso$")

            @self._app.command(_slash_pattern)
            async def handle_cocso_command(ack, command):
                await ack()
            ...
            for _action_id in (
                "cocso_approve_once",
                "cocso_approve_session",
                "cocso_approve_always",
                "cocso_deny",
            ):
            ...
            for _action_id in (
                "cocso_confirm_once",
                "cocso_confirm_always",
                "cocso_confirm_cancel",
            ):
    ...
    def _dm_top_level_threads_as_sessions(self) -> bool:
        ...
        own COCSO session — matching the per-thread behavior channels already
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "cocso_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "cocso_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "cocso_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "cocso_confirm_once",
                            "value": value,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Approve"},
                            "action_id": "cocso_confirm_always",
                            "value": value,
                        },
                        {
                            "type": "button",
                            ...
                            "style": "danger",
                            "action_id": "cocso_confirm_cancel",
                            "value": value,
                        },
                    ],
                },
    ...
    async def _handle_slash_confirm_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "cocso_confirm_once": "once",
            "cocso_confirm_always": "always",
            "cocso_confirm_cancel": "cancel",
        }
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "cocso_approve_once": "once",
            "cocso_approve_session": "session",
            "cocso_approve_always": "always",
            "cocso_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        The legacy ``/cocso <subcommand> [args]`` form is preserved for
        backward compatibility with older workspace manifests and for users
        who want a single entry point for free-form questions (``/cocso
        ...
        if slash_name in ("cocso", ""):
            # Legacy /cocso <subcommand> [args] routing + free-form questions.
            # Empty slash_name falls into this branch for backward compat
            # with any caller that didn't populate command["command"].
            from cocso_cli.commands import slack_subcommand_map
