#!/usr/bin/env python3
"""Build the COCSO Skills Index — a centralized JSON catalog of all skills.
...
`cocso skills search/install` can use it without hitting the GitHub API.
...
# Ensure COCSO_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("COCSO_HOME", os.path.join(os.path.expanduser("~"), ".cocso"))
...
def main():
    print("Building COCSO Skills Index...", flush=True)
