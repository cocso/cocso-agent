...
Usage:
    cocso pairing list              # Show all pending + approved users
    cocso pairing approve <platform> <code>  # Approve a pairing code
    cocso pairing revoke <platform> <user_id> # Revoke user access
    cocso pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle cocso pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: cocso pairing {list|approve|revoke|clear-pending}")
        print("Run 'cocso pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'cocso pairing list' to see pending codes.\n")
