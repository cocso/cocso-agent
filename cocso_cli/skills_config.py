"""
Skills configuration for COCSO Agent.
`cocso skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.cocso/config.yaml under:
...
from cocso_cli.config import cfg_get, load_config, save_config
from cocso_cli.colors import Colors, color
from cocso_cli.platforms import PLATFORMS as _PLATFORMS
