...
Trust levels:
  - builtin:   Ships with COCSO. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.cocso/\.env|\~/\.cocso/\.env',
     "cocso_env_access", "critical", "exfiltration",
     "directly references COCSO secrets file"),
    ...
    (r'\.cocso/config\.yaml|\.cocso/SOUL\.md',
     "cocso_config_mod", "critical", "persistence",
     "references COCSO configuration files directly"),
