...
from cocso_core.toolsets import resolve_toolset, validate_toolset
...
#   - cocso_cli/*               -> inline on startup (no event loop)
...
def get_tool_definitions(
    ...
    if quiet_mode:
        try:
            from cocso_cli.config import get_config_path
...
def _compute_tool_definitions(
    ...
    if enabled_toolsets is not None:
        ...
        from cocso_core.toolsets import get_all_toolsets
