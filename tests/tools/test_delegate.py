...
class TestDelegateTask(unittest.TestCase):
    ...
    def test_depth_increments(self):
        ...
        with patch("cocso_cli.run_agent.AIAgent") as MockAgent:
...
class TestToolNamePreservation(unittest.TestCase):
    ...
    def test_build_child_agent_does_not_raise_name_error(self):
        ...
        with patch("cocso_cli.run_agent.AIAgent"):
            try:
                _build_child_agent(
                    task_index=0,
...
class TestDelegationCredentialResolution(unittest.TestCase):
    ...
    @patch("cocso_cli.runtime_provider.resolve_runtime_provider")
...
class TestDelegationReasoningEffort(unittest.TestCase):
    ...
    @patch("tools.delegate_tool._load_config")
    @patch("cocso_cli.run_agent.AIAgent")
...
class TestOrchestratorRoleBehavior(unittest.TestCase):
    ...
    def test_batch_mode_per_task_role_override(self, mock_cfg, mock_creds):
        ...
        with patch("cocso_cli.run_agent.AIAgent", side_effect=_factory):
            delegate_task(
                tasks=[
...
class TestOrchestratorEndToEnd(unittest.TestCase):
    ...
    def test_end_to_end_nested_orchestration(self, mock_cfg, mock_creds):
        ...
        with patch("cocso_cli.run_agent.AIAgent", side_effect=_factory) as MockAgent:
            delegate_task(
