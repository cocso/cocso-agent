#!/usr/bin/env python3
"""
SWE Runner with Cocso Trajectory Format

A runner that uses Cocso-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Cocso-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Cocso-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Cocso format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Cocso-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Cocso-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Cocso Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Cocso-Agent's built-in execution environments
    and outputs trajectories in Cocso-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Cocso trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Cocso trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Cocso trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Cocso Trajectory Format")
    print("=" * 60)
